...
class StaticVlmCausalLMBatch(CausalLMBatch):
    ...
    @classmethod
    def recombine(cls, batches: List["StaticVlmCausalLMBatch"], pad_token_id: int, is_warmup: bool =False) -> "StaticVlmCausalLMBatch":
...
class StaticVlmCausalLM(Model):
    def __init__(
        ...
        *,
        ...
        batch_class=StaticVlmCausalLMBatch,
        revision,
        ...
        **kwargs,
        ...
        super(StaticVlmCausalLM, self).__init__(
            model_id=model_id,
            model=model,
            tokenizer=tokenizer,
    ...
    @property
    def batch_type(self) -> Type[StaticVlmCausalLMBatch]:
    ...
    def generate_token(
        self, batches: List[StaticVlmCausalLMBatch], is_warmup: bool = False
    ...
    def batch_from_pb(self, batch, is_warmup):
        return StaticVlmCausalLMBatch.from_pb_processor(
            batch,
            self.tokenizer,
            self.processor,
            self.model.config,
