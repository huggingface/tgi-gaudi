...
> [!WARNING]
> This repository is deprecated. Please use the [text-generation-inference](https://github.com/huggingface/text-generation-inference) repository instead for the latest version of TGI on Habana Gaudi. You should now use the latest image hosted on the TGI repo `ghcr.io/huggingface/text-generation-inference:latest-gaudi` instead of `ghcr.io/huggingface/tgi-gaudi:latest`. You can find the new Gaudi images in the [text-generation-inference](https://github.com/huggingface/text-generation-inference/pkgs/container/text-generation-inference) registry. You can also check the [Gaudi Backend documentation](https://huggingface.co/docs/text-generation-inference/en/backends/gaudi) for more information. 
